        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                  <div class="w-10">
                    <img src="{{ asset('assets/logo.png') }}" class="w-full h-auto"/>
                  </div>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="/prisoners" :active="request()->routeIs('prisoners')">
                      {{ __('Prisoners') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="/administration" :active="request()->routeIs('administration')">
                      {{ __('Administration') }}
                    </x-jet-nav-link>
                </div>
            </div>
